...
async function runCode({language = "", code = "", input = ""}) {
    ...
    const result = await new Promise((resolve, reject) => {
        ...
        const timer = setTimeout(async () => {
            ...
            reject({
                status: 408,
                error: `DeepCode API Timed Out. Your code took too long to execute, over ${timeout} seconds. Make sure you are sending input as payload if your code expects an input.`
            })
        }, timeout * 1000);
